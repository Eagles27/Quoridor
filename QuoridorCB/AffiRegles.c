...
void affiregles()
{
    ...
    printf("\n");
    printf("Si une barriere se trouve derri�re le pion saute, le joueur peut choisir de bifurquer a droite ou a gauche du pion saute.\n");
    system("PAUSE");
    printf("////////////////////\n");
    ...
    printf("Les regles sont strictement identiques, mais on ne peut sauter plus d'un pion � la fois.\n");
    system("PAUSE");
    system("cls");
}
