        ...
        else
        {
            ...
            else
            {
                ...
                if(ia.barrieresR !=0)
                {
                    ...
                    {
                        mat[player[0].coordonneY+1][player[0].coordonneX] = 3;
                        mat[player[0].coordonneY+1][player[0].coordonneX+1] = 3;
                        mat[player[0].coordonneY+1][player[0].coordonneX+2] = 3;
                        return 2;
                    ...
                    //Sinon la suivante...
                    else if((mat[15][2]==1)&&(mat[15][4]==1)&&(mat[15][3]==1))
                    {
                        mat[15][2] = 3;
                        mat[15][3] = 3;
                        mat[15][4] = 3;
                    ...
                    else if((mat[15][4]==1)&&(mat[15][6]==1)&&(mat[15][5]==1))
                    {
                        mat[15][4] = 3;
                        mat[15][5] = 3;
                        mat[15][6] = 3;
                    ...
                    else if((mat[15][6]==1)&&(mat[15][8]==1)&&(mat[15][7]==1))
                    {
                        mat[15][6] = 3;
                        mat[15][7] = 3;
                        mat[15][8] = 3;
                    ...
                    else if((mat[15][8]==1)&&(mat[15][10]==1)&&(mat[15][9]==1))
                    {
                        mat[15][8] = 3;
                        mat[15][9] = 3;
                        mat[15][10] = 3;
                    ...
                    else if((mat[15][10]==1)&&(mat[15][12]==1)&&(mat[15][11]==1))
                    {
                        mat[15][10] = 3;
                        mat[15][11] = 3;
                        mat[15][12] = 3;
                    ...
                    else if((mat[15][12]==1)&&(mat[15][14]==1)&&(mat[15][13]==1))
                    {
                        mat[15][12] = 3;
                        mat[15][13] = 3;
                        mat[15][14] = 3;
